...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Cashmere Scarf",
    description:
      "Woven from the finest Mongolian cashmere, this luxuriously soft scarf provides exceptional warmth and comfort. The timeless design and subtle pattern make it a versatile addition to any wardrobe. Available in multiple colorways.",
    price: 220,
    category: "accessories",
  ...
  },
  {
    ...
    description:
      "This hand-cut crystal decanter and matching tumblers are crafted by master artisans. The distinctive design catches and refracts light beautifully, making it a statement piece for any home bar. The set includes a decanter and four tumblers.",
    price: 299,
    category: "home",
  ...
  },
  {
    ...
    description:
      "This luxuriously soft cashmere throw is hand-woven by skilled artisans. Perfect for adding warmth and texture to any living space, it's available in a range of sophisticated colors to complement your home décor.",
    price: 350,
    category: "home",
  ...
  },
  {
    ...
    description:
      "Each of these ceramic vases is uniquely handcrafted by skilled artisans. The organic forms and subtle glazes create a piece that's both a functional vase and a striking sculptural object for your home.",
    price: 180,
    category: "home",
  ...
  },
  {
    ...
    description:
      "This premium digital audio player is designed for audiophiles who demand the highest sound quality. Supporting multiple high-resolution audio formats and featuring a dual DAC system, it reproduces music with exceptional detail and clarity.",
    price: 1100,
    category: "electronics",
  ...
  },
  {
    ...
    description:
      "Elegance meets precision in this rose gold ladies' watch. The mother-of-pearl dial is adorned with diamond hour markers, and the Swiss quartz movement ensures reliable timekeeping. Water-resistant to 50 meters.",
    price: 1750,
    category: "watches",
